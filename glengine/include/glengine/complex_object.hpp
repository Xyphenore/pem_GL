...
#ifndef GLENGINE_COMPLEX_OBJECT_HPP
#define GLENGINE_COMPLEX_OBJECT_HPP

#include <glengine/abstract_object.hpp>

namespace gl_engine {
    class ComplexObject final : public AbstractObject {

    };
}

#endif // GLENGINE_COMPLEX_OBJECT_HPP
